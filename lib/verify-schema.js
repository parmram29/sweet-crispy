 ...
 * against an older database (e.g. pulling code that renamed
 * `orders.stripe_session_id` to `payment_ref`, or added the `payment_events`
 * table, without re-running db/schema.sql). Without
...
const REQUIRED = {
  ...
  orders:         ['id', 'order_ref', 'customer_name', 'phone',
                   'subtotal_ec', 'total_ec', 'status', 'payment_method', 'payment_status',
